...
from agent_tools_azure import TOOLS_OPENAI, execute_tool, get_tool_names, qdrant_client, COLLECTION_NAME_V2

logging.basicConfig(level=logging.INFO, format="%(asctime)s | %(levelname)s | %(name)s | %(message)s")
logger = logging.getLogger("RAG-Azure-Tools")
...
app = FastAPI(title="Azure RAG (Tool-Calling Agent)", version="0.1.0")
...
if __name__ == "__main__":
    import uvicorn
    PORT = int(os.getenv("SERVICE_PORT", "7887"))
